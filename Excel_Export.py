...
def GetVisumData():
    ...
    Data.append(["Sum Links VehKmTravPrT(AP)",List.Sum(0)]) #uzyskuje sume kolumny z Visuma i zapisuje do Data wraz z tytulem (pierwszy string to tytul, drugi to wartosc) 
    Data.append(["Sum Links VehHourTravtCur(AP)",List.Sum(1)]) #jw
...
dodajdoExcela(Data) #zapisz dane do Excela